...
public static class Utils
{
    ...
    static NamesList CurrentNamesList
    {
        get
        {
            if (_namesList == null)
            {
                //TODO: change Text asset by name list text
    ...
    public static void ChangeAlpha(this Color color, float alphaValue, float duration)
    {
        var colorTemp = color;
        var alpha = colorTemp.a;

        DOVirtual.Float(alpha, alphaValue, duration, x =>
        {
            colorTemp = new Color(color.r, color.g, color.b, x);
            color = colorTemp;
        });
    }
    ...
    public static KeyValuePair<TKey, TValue> GetRandomElement<TKey, TValue>(this 
        SerializedDictionary<TKey, TValue> dictionary)
    {
