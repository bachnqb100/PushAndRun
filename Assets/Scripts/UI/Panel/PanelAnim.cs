...
namespace DefaultNamespace.UI
{
    public class PanelAnim : MonoBehaviour
    {
        ...
        [Header("EaseType")]
        [ShowIf(nameof(ShowAnimInEasingType))] public EasingType animInEasingType = EasingType.OutQuad;

        [ShowIf(nameof(UseAnimInCurve))] public AnimationCurve animInCurve = AnimationCurve.EaseInOut(0, 0, 1, 1);
        ...
        [ShowIf(nameof(UseAnimOutCurve))] public AnimationCurve animOutCurve = AnimationCurve.EaseInOut(0, 0, 1, 1);
        ...
        private bool UseXAxisAnimOutCurve =>
            ShowSeparateAnimOutEasingType && animOutXAxisEasingType == EasingType.Custom;

        private bool UseYAxisAnimOutCurve =>
            ShowSeparateAnimOutEasingType && animOutYAxisEasingType == EasingType.Custom;
        ...
        [ShowIf(nameof(UsePopupAnim))] public RectTransform popup;
            ...
            switch (animIn)
            {
                case AnimInType.FromTop:
                    ...
                    if (UsePopupAnim && popup)
                    {
                        ...
                        float offset = rootRect.height / 2 + (rootRect.center.y - popupRect.center.y) +
                                       popupRect.height / 2;
                ...
                case AnimInType.FromLeft:
                    ...
                    if (UsePopupAnim && popup)
                    {
                        ...
                        float offset = rootRect.width / 2 - (rootRect.center.x - popupRect.center.x) +
                                       popupRect.width / 2;
        ...
        public void StartAnimOut()
        {
            ...
            switch (animOut)
            {
                ...
                case AnimOutType.FadeAlpha:
                    ...
                    {
                        rootGraphic.alpha = 1f;
                        rootGraphic.DOFade(0f, animOutTime).SetUpdate(unscaleTime)
                            .OnComplete(() => { OnAnimOutComplete(); });
                    }
