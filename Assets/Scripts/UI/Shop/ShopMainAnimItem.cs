...
{
    public class ShopMainAnimItem : MonoBehaviour
    {
        [Header("Background")] 
        ...
        private AnimMainConfig _config;
        ...
        [Button]
        public void Init(MainAnimType type, Action onSelect, Action onUse)
        {
            _onSelect = onSelect;
            _onUse = onUse;
            
            _config = ConfigManager.Instance.animMainGroupConfig.GetAnimMainConfig(type);
            ...
            if (_config)
            {
                ...
                exclusive.SetActive(!GameManager.Instance.GameData.userData.mainAnimItemStatusMap[type] && _config.isExclusive);
        ...
        void UpdateData()
        {
            btnUse.gameObject.SetActive(GameManager.Instance.GameData.userData.mainAnimItemStatusMap[_config.type]);
            btnAds.gameObject.SetActive(!GameManager.Instance.GameData.userData.mainAnimItemStatusMap[_config.type] && _config.isAdsUnlock);
            btnMoney.gameObject.SetActive(!GameManager.Instance.GameData.userData.mainAnimItemStatusMap[_config.type] &&
                                          !_config.isExclusive && !_config.isAdsUnlock);
                
            if (_config.isAdsUnlock)
                priceAds.text = GameManager.Instance.GameData.userData.mainAnimItemPriceMap[_config.type].ToString() + "/" +
                                _config.price;
        ...
        void Select()
        {
            ...
            GameController.Instance.Player.AnimController.SetAnimMain(_config.type);
        }
        ...
        public void Use()
        {
            ...
            //TODO: Logic Use
            GameManager.Instance.GameData.userData.currentMainAnimType = _config.type;
        }
